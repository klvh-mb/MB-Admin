...
$(function(){
// hover scroll visible function
	/*$('.in-yel-contant, .dash-buy-scroll, .scrolly, .patient-inquiry, .patient-find-scroll, .scroll-box, .categoryitems.scrolly, .popup-contant-box.scrolly, .nt-aval, .categoryite0msy, .fax-scrolly, .frequent-list-box, .d-scrolling').hover(function(){
		$(this).find('.jspVerticalBar').fadeIn();
	},function(){
		$(this).find('.jspVerticalBar').fadeOut(600);
	});*/
	//jscrollpane
	var api = $('.in-yel-contant, .dash-buy-scroll, .scrolly, .patient-inquiry, .patient-find-scroll, .scroll-box, .categoryitems.scrolly, .popup-contant-box.scrolly, .nt-aval, .categoryit0emsy, .fax-scrolly, .frequent-list-box, .d-scrolling').jScrollPane(
	{
		showArrows:false,
